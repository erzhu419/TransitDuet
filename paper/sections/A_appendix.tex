...
%% ---------------------------------------------------------------
\section{Cross-level coupling: derivation of the hindsight credit}
\label{app:coupling_derivation}

This appendix details the trip-lifecycle hindsight credit on the upper-level reward (Eq.~\ref{eq:hindsight_reward} in \cref{sec:tap}) and connects it to the synchronous cross-advantage objective of \citet{pan2024roboduet}.
