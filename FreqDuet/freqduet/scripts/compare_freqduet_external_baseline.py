...
CANDIDATE_METHOD_TOKENS = (
    ...
    "snapshotriskdual_compresssafe10_terminalonly",
    "snapshotriskdual_compresssafe10",
    "snapshotriskdual_compresssafe15",
    "upperhist_fixedguard",
    "upperhist_safe",
    "upperhist_bestmix",
    "upperhist4_nocompress",
    "upperhist4_relief10",
    "upperhist4_balanced",
    "upperhist4_terminalonly",
    "upperhist5",
    "upperhist4",
    "upperhist3",
    "freeze100",
    ...
    "snapshotactorrel",
    "snapshotriskdual_targetnonpos_domainmix_terminalonly",
    "snapshotriskdual_targetnonpos_domainmix",
    "snapshotriskdual_targetnonpos_riskmargin_balanced_terminalonly",
    "snapshotriskdual_targetnonpos_riskmargin_balanced",
    "snapshotriskdual_targetnonpos_riskmargin_tight",
    "snapshotriskdual_targetnonpos_riskmargin_offset",
    "snapshotriskdual_targetnonpos_riskgate08",
    "snapshotriskdual_targetnonpos_riskgate12_terminalonly",
    "snapshotriskdual_targetnonpos_riskgate12_fixedodrush",
    "snapshotriskdual_targetnonpos_riskgate12_fixedrush",
    "snapshotriskdual_targetnonpos_riskgate12",
    ...
    "snapshotriskdual_targetonly_terminalonly",
    "snapshotriskdual_targetonly",
    "snapshotriskdual",
    "snapshotriskvalue_targetonly",
    "snapshotriskvalue",
    "fixedfallback_domainrisk",
    "fixedfallback_domain",
    "fixedfallback_noharm",
    "snapshotriskmix",
    "snapshotriskpenalty",
    "snapshotodtermcap",
    "snapshotdomaincap",
    ...
    "cfaction_target_dp0_terminalonly",
    "headfloor100",
    "headfloor095",
    "valuesoft35_lfsafe",
    "valuesoft35",
