...
METHOD_PARENTS = {
    ...
    "uppervalue_hfgate": "../F_freqduet_terminal_main_uppervalue_hfgate_hiro.yaml",
    "termvalselector": "../F_freqduet_terminal_main_termvalselector_hiro.yaml",
    "headwayplanner": "../F_freqduet_terminal_main_headwayplanner_hiro.yaml",
    "releaseadapt": "../F_freqduet_terminal_main_releaseadapt_hiro.yaml",
    "release20": "../F_freqduet_terminal_main_release20_hiro.yaml",
    "release15": "../F_freqduet_terminal_main_release15_hiro.yaml",
    "release10": "../F_freqduet_terminal_main_release10_hiro.yaml",
    "release5": "../F_freqduet_terminal_main_release5_hiro.yaml",
    "ctxselector60": "../F_freqduet_terminal_main_ctxselector60_hiro.yaml",
    "upperdisc3": "../F_freqduet_terminal_main_upperdisc3_hiro.yaml",
    "upperdisc4": "../F_freqduet_terminal_main_upperdisc4_hiro.yaml",
    "upperdisc5": "../F_freqduet_terminal_main_upperdisc5_hiro.yaml",
    "upperdisc7": "../F_freqduet_terminal_main_upperdisc7_hiro.yaml",
    "spline2dir_promreplan": "../F_freqduet_terminal_main_spline2dir_promreplan_hiro.yaml",
    "spacectx": "../F_freqduet_terminal_main_spacectx_hiro.yaml",
    "spacectx_disc9": "../F_freqduet_terminal_main_spacectx_disc9_hiro.yaml",
    "gapctx_disc9last": "../F_freqduet_terminal_main_gapctx_disc9last_hiro.yaml",
    "disc9last": "../F_freqduet_terminal_main_disc9last_hiro.yaml",
    "disc9": "../F_freqduet_terminal_main_disc9_hiro.yaml",
