...
ANALYSIS_FILES = [
    ...
    "scripts/audit_protocol_v6_v26_historical_calibration_common.py",
    "scripts/audit_protocol_v6_v26_historical_calibration_screen.py",
    "scripts/audit_protocol_v6_v26_historical_calibration_smoke.py",
    "scripts/audit_protocol_v6_v27_multistep_value_common.py",
    "scripts/audit_protocol_v6_v27_multistep_value_screen.py",
    "scripts/audit_protocol_v6_v27_multistep_value_smoke.py",
    "scripts/audit_protocol_v6_v33_timescale_screen.py",
    ...
    "scripts/submit_freqduet_protocol_v6_v33_confirmation_scheduleurm.py",
    "scripts/submit_freqduet_protocol_v6_v33_timescale_scheduleurm.py",
