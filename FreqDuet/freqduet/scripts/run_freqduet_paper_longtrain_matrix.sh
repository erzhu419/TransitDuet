...
# Current-version long-training matrix for the FreqDuet paper backlog.
# This intentionally mirrors the 2026-06-02 current-name final matrix:
# 4 domains x 6 methods x 20 paired seeds.
