#!/usr/bin/env python3
"""Submit or merge the source-bound Freq-HRL v7.4 budget ladder."""
...
from freq_hrl.experiments.trading import (  # noqa: E402
    full_method_budget_plan_v74 as plan,
)
from freq_hrl.experiments.trading import (  # noqa: E402
    full_method_budget_validation_v74 as validation,
)
...
SIGNATURE_VERSION = "budget-v7-4-robust-checkpoint-source-bound"
...
def build_scheduler_spec(
    ...
    *,
    ...
    return {
        ...
        "description": (
            f"Freq-HRL v7.4 budget {budget} {variant_id} "
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--project", default="Freq-HRL-v7.4-Budget")
...
def main() -> None:
    ...
    try:
        ...
        raise SystemExit(f"cannot bind v7.4 budget source: {exc}") from exc
    ...
    if not cells:
        print("no v7.4 budget cells require submission")
        return
    print(
    ...
    execute_bulk(
        ...
        intent_label=f"Freq-HRL v7.4 budget ladder {args.run_name}",
    )
