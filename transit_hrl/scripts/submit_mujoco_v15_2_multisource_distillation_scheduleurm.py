#!/usr/bin/env python3
"""Submit the frozen v15.2 multi-source development preflight."""
...
from scripts.analyze_mujoco_v15_2_multisource_distillation import analyze_run
from scripts import submit_mujoco_v15_raw_policy_distillation_scheduleurm as base


ROOT = Path(__file__).resolve().parents[1]
LAUNCHER_PATH = Path(__file__).resolve()
SIGNATURE_VERSION = "mujoco-v15-2-multisource-distillation-preflight-v1"
...
def _build_probe_command(args, environment: str, seed: int) -> str:
    ...
    command = [
        ...
        "scripts/probe_mujoco_v15_2_multisource_distillation.py",
...
def _write_preregistration(args) -> None:
    ...
    payload = {
        "status": "frozen_before_v15_2_development_outcome_access",
        ...
        "failed_predecessor_run": (
            "mujoco_v15_1_bounded_distillation_preflight_20260830_r1"
        ),
