#!/usr/bin/env python3
"""Source-preserving runtime for frozen MuJoCo v12 confirmatory cells."""
...
LAUNCHER_PATH = Path(__file__).with_name(
    "submit_mujoco_v12_confirmatory_scheduleurm.py"
)
...
def _annotate_summary(
    ...
    *,
    ...
    payload.update({
        ...
        "confirmatory_seed_namespace": "mujoco_v12_confirmatory",
    })
    path.write_text(
...
def main() -> None:
    ...
    print(
        "mujoco_v12_confirmatory_cell status=valid "
