#!/usr/bin/env python3
"""Submit v17.8 reused-path dataset exports through scheduleurm."""
...
WORKER = Path("scripts/export_mujoco_v17_8_oracle_dataset_path.py")
SIGNATURE_VERSION = "mujoco-v17-8-causal-fir-dataset-v1"
...
def build_scheduler_spec(
    ...
    return {
        ...
        "description": (
            f"Freq-HRL v17.8 dataset {environment} {mode} {seed}"
        ),
...
def write_registration(args: argparse.Namespace) -> None:
    ...
    payload = {
        "status": "registered_before_v17_8_reused_trace_export",
        ...
        "fresh_validation_seeds_frozen_before_access": list(
            spec.FRESH_VALIDATION_SEEDS
        ),
        ...
        "scheduler_contract": {
            ...
            "require_node": DATA_LOCAL_NODE,
            "binding_reason": (
                "source checkpoints and generated training arrays remain "
