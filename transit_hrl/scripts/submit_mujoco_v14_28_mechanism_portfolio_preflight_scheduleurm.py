#!/usr/bin/env python3
"""Submit the frozen MuJoCo v14.28 restoration portfolio preflight."""
...
from scripts.analyze_mujoco_v14_28_mechanism_portfolio_preflight import analyze_run
...
def _write_preregistration(args) -> None:
    ...
    payload = {
        "status": "frozen_before_v14_28_preflight_outcome_access",
