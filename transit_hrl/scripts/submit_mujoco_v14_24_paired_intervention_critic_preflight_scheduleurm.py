#!/usr/bin/env python3
"""Submit the frozen MuJoCo v14.24 paired-intervention critic preflight."""
...
from scripts.analyze_mujoco_v14_24_paired_intervention_critic_preflight import analyze_run
from scripts import submit_mujoco_v14_18_router_probe_scheduleurm as base


LAUNCHER_PATH = Path(__file__).resolve()
SIGNATURE_VERSION = "mujoco-v14-24-paired-intervention-critic-preflight-v1"
...
def _write_preregistration(args) -> None:
    ...
    payload = {
        "status": "frozen_before_v14_24_preflight_outcome_access",
