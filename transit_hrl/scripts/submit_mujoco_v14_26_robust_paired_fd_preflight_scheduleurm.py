#!/usr/bin/env python3
"""Submit the frozen MuJoCo v14.26 robust paired-FD preflight."""
...
from scripts.analyze_mujoco_v14_26_robust_paired_fd_preflight import analyze_run
from scripts import submit_mujoco_v14_18_router_probe_scheduleurm as base


LAUNCHER_PATH = Path(__file__).resolve()
SIGNATURE_VERSION = "mujoco-v14-26-robust-paired-fd-preflight-v1"
...
def _write_preregistration(args) -> None:
    ...
    payload = {
        "status": "frozen_before_v14_26_preflight_outcome_access",
