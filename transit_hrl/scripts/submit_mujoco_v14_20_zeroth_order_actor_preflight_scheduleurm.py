#!/usr/bin/env python3
"""Submit the frozen MuJoCo v14.20 zeroth-order actor preflight."""
...
from scripts.analyze_mujoco_v14_20_zeroth_order_actor_preflight import analyze_run
from scripts import submit_mujoco_v14_18_router_probe_scheduleurm as base


LAUNCHER_PATH = Path(__file__).resolve()
SIGNATURE_VERSION = "mujoco-v14-20-zeroth-order-actor-preflight-v1"
...
def _write_preregistration(args) -> None:
    ...
    payload = {
        "status": "frozen_before_v14_20_preflight_outcome_access",
        ...
        "scheduler_contract": {
            ...
            "require_node": None, "cpu_per_task": 1,
            "ram_mb_per_task": 768, "slurm_used": False,
        },
    }
