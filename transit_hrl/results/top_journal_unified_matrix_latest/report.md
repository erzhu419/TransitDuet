...
|---|---|---|---|---|
| C1 | Native learned promotion improves reward and wait | partial | best=native_promotion_v21 reward=supported reward_noharm=supported wait=inconclusive wait_noharm=supported | Wait CI must be supported together with reward in the same native run. |
