...
| C6 | Formal theory appendix covers main protocol claims | supported | examples=['credit_residual_bound_example', 'leakage_bound_example', 'paired_ci_radius_example', 'primal_dual_avg_violation_bound_example', 'promotion_detection_delay_bound_s', 'promotion_false_positive_bound_example'] | Theory appendix now has structured theorem/proof rows; remaining work is manuscript notation polish and reviewer-facing assumption calibration. |
