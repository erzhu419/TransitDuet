...
| C8: passenger waiting-time frequency credit improves control quality | supported | surrogate wait delta=-0.1251 [-0.1468, -0.1020]; native final wait delta=NA; native score delta=NA; native reward delta=NA | Native wait-credit validation harness exists, but native timetable performance is not yet supported. |
