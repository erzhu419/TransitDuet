...
| C6: public-data validation covers more than daily bars | supported path | best intraday encoder=adaptive_wavelet, Sharpe=-9.2200; best order-book encoder=state_space, Sharpe=299.9851; best stress encoder=adaptive_wavelet under stale_book, Sharpe=243.4833; stress adaptive Sharpe=+0.2807 [-0.3942, +0.9004] | Order-book adapter and stress matrix exist with deterministic CI fixtures; larger real L2/L3 feeds and a full exchange matching simulator remain for the strongest data claim. |
| C7: integrated native Transit Freq-HRL closes the copied-runner gap | supported | reward delta=+0.0565 [+0.0485, +0.0608]; wait delta=-0.0758 [-0.0815, -0.0651]; drift delta=-0.0199 [-0.0199, -0.0198]; native-loop samples=4970 | Supported on surrogate performance plus a native shared-PPO episode loop and real AFC/APC demand replay; still needs multi-seed native performance under true onboard-load/alighting/OD dynamics. |
| C8: passenger waiting-time frequency credit improves control quality | supported native+real-demand | surrogate wait delta=-0.1251 [-0.1468, -0.1020]; native final wait delta=-8.5908 [-20.4276, -0.9074]; native score delta=+8.6724 [+1.0542, +20.4807]; native reward delta=+2037.3278 [-66.8598, +6165.1210]; real-demand objective delta=+1.8114 [+1.2826, +2.4539]; real-demand wait delta=-1.6741 [-2.2818, -1.1728] | Native wait-credit path is supported in the shared-PPO loop and real-demand replay is present; still needs native onboard-load/alighting/OD validation. |
...
| C10: causal count-state demand estimators support Transit demand validation | supported afc+apc-calibrated+control | all-demand MSE delta=+4202.4659 [+1172.4726, +8434.5613]; AFC NB MSE delta=+16121.7347 [+6009.5751, +31280.0939]; AFC profile MSE delta=-7186235.1828 [-10935870.1938, -4496470.4747]; APC profile MSE delta=-5034.9993 [-8843.9598, -2369.0635]; real-control objective delta=+1.8114 [+1.2826, +2.4539] | Real AFC station-hour and APC route-boarding paths are present with supported calibrated profiles and control replay; true onboard-load/alighting/OD feeds remain open. |
