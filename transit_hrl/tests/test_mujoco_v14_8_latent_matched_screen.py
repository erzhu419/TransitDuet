...
from scripts import mujoco_v14_8_latent_matched_screen_spec as spec
from scripts.analyze_mujoco_v14_8_latent_matched_screen import analyze
from scripts.submit_mujoco_v14_8_latent_matched_screen_scheduleurm import (
    ANCHOR_ARM,
...
class MujocoV148LatentMatchedScreenTest(unittest.TestCase):
    @staticmethod
    def _args() -> argparse.Namespace:
        return argparse.Namespace(
            run_name="unit_v14_8_screen",
    ...
    def test_registry_commands_and_dynamic_scheduler_contract(self):
        ...
        self.assertIn("--upper-dual-lr 0.1", learned)
        self.assertIn("--lower-dual-lr 0.1", learned)
    ...
    def test_all_v148_seed_roles_are_fresh_and_disjoint(self):
        old = set()
        for module in (
